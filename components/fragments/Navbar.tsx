...
const Navbar = () => {
    return (
        <div className="sticky top-0 px-6 pb-4 lg:px-20 md:px-20 sm:px-8 dark:text-gray-700 dark:bg-[#0a0a0a] text-gray-900 bg-slate-100 z-50" id="navbar">
            <div className="flex flex-row h-20 justify-between items-center py-7 border-b-2 dark:border-gray-500 border-gray-500">
                ...
                <div className="flex flex-row items-center lg:gap-12 md:gap-10 gap-4 sm:gap-8 h-full justify-center sm:justify-center md:justify-end lg:justify-end dark:text-white text-gray-900 sm:font-semibold">
